...
const Hero = ({ lang }: { lang: string }) => {
  return (
    <div className="my-2 flex flex-col items-center justify-center gap-2 md:gap-0 px-3 text-start md:my-4 md:flex-row md:justify-between">
      <div className="flex items-center justify-start md:gap-1 lg:gap-5">
      ...
      <Link
        ...
        className="rounded-full bg-red-600 p-3 text-lg font-bold text-gray-100 transition-colors duration-100 hover:bg-red-700 md:p-4 md:text-2xl lg:text-3xl"
        target="_blank"
      >
        শহীদদের তথ্য দিন
      </Link>
