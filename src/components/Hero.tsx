  ...
  return (
    <div className="my-2 flex flex-col items-center justify-center gap-2 px-3 text-start md:my-4 md:flex-row md:justify-between md:gap-0">
      ...
      <Link
        ...
        className="rounded-full bg-red-600 p-3 text-lg font-bold text-gray-100 underline decoration-red-300 underline-offset-4 transition-colors duration-100 hover:bg-red-700 md:p-4 md:text-xl lg:text-2xl"
        target="_blank"
      >
